...
plt.rcParams.update({
    ...
    'font.size': 14,  # 基础字体大小（调大）
    'axes.titlesize': 18,  # 标题字体大小（最大）
    'axes.labelsize': 16,  # 坐标轴标签字体大小（略小于标题）
    'xtick.labelsize': 14,  # x轴刻度字体大小
    'ytick.labelsize': 16,  # y轴刻度字体大小（略小于标题）
...
picture_dir = '/home/aistudio/work/cnn_lstm_CD20_PICTURE'
...
model_state_dict = paddle.load(os.path.join(save_dir, 'final_cnn_lstm_model.pdparams'))
...
print(f"All plots saved to: {picture_dir}")