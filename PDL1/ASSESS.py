...
# 设置路径 - 修改为新路径
data_dir = '/home/aistudio/data/PD-L1'  # 数据目录保持不变，若有PD-L1数据目录可修改
save_dir = '/home/aistudio/work/cnn_lstm_PD-L1'  # 模型保存目录修改
picture_dir = '/home/aistudio/work/cnn_lstm_PD-L1_PICTURE'  # 图片保存目录修改
...
# 数据加载和预测
class_names = ['18000000', '9000000', '1800000', '600000', '150000', '30000', '6000', '3000']  # 更新为新类别
...
model_state_dict = paddle.load(os.path.join(save_dir, 'best_cnn_lstm_model.pdparams'))  # 新模型路径
